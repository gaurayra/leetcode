class Solution {
    ...
    public int[] maximumWeight(List<List<Integer>> intervals) {
        ...
        // If we reach the end, answer is empty
        for (int k = 1; k <= 4; k++) {
    ...
    // If scores are equal, choose lexicographically smaller list
